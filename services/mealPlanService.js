...
function mealTemplateBank(profile, history = {}, ingredientRules = {}) {
  const bank = {
    Breakfast: [
      ...
      { name: "Oatmeal with berries and apple", components: ["oatmeal", "berries", "apple"], target: 310 },
      { name: "Rice porridge with egg white", components: ["rice porridge", "egg white"], target: 290 },
      { name: "Bread toast with apple butter", components: ["white bread", "apple"], target: 270 },
      { name: "Cream of wheat with pear", components: ["cream of wheat", "pear"], target: 260 },
      { name: "Egg white toast with berries", components: ["egg white", "toast", "berries"], target: 290 },
      { name: "Rice cereal with berries", components: ["rice cereal", "berries"], target: 280 },
    ],
    "AM Snack": [
      ...
      { name: "Rice cakes", components: ["rice cakes"], target: 140 },
      { name: "Unsalted popcorn", components: ["unsalted popcorn"], target: 160 },
    ],
    Lunch: [
      ...
      { name: "Tilapia with pasta and cucumber", components: ["tilapia", "pasta", "cucumber"], target: 420 },
      { name: "Chicken with couscous and green beans", components: ["chicken breast", "couscous", "green beans"], target: 430 },
      { name: "Turkey barley with cauliflower", components: ["turkey", "barley", "cauliflower"], target: 410 },
      { name: "Fish pasta with lettuce", components: ["fish", "pasta", "lettuce"], target: 410 },
      { name: "Chicken rice with onion and cabbage", components: ["chicken breast", "white rice", "onion", "cabbage"], target: 440 },
      { name: "Turkey rice with radish salad", components: ["turkey", "white rice", "radish"], target: 400 },
      { name: "Tilapia barley with cucumber", components: ["tilapia", "barley", "cucumber"], target: 410 },
      { name: "Egg white pasta with vegetables", components: ["egg white", "pasta", "cauliflower", "cucumber"], target: 400 },
      { name: "Chicken couscous with green beans", components: ["chicken breast", "couscous", "green beans"], target: 420 },
      { name: "Fish rice with green beans and onion", components: ["fish", "white rice", "green beans", "onion"], target: 430 },
    ],
    "PM Snack": [
      ...
      { name: "Pear slices", components: ["pear"], target: 140 },
      { name: "Berries and rice cakes", components: ["berries", "rice cakes"], target: 150 },
      { name: "Apple with crackers", components: ["apple", "rice crackers"], target: 160 },
      { name: "Grapes with unsalted popcorn", components: ["grapes", "unsalted popcorn"], target: 160 },
      { name: "Cucumber slices", components: ["cucumber"], target: 120 },
    ],
    Dinner: [
      ...
      { name: "Tilapia barley with cabbage", components: ["tilapia", "barley", "cabbage"], target: 420 },
      { name: "Turkey pasta with cauliflower", components: ["turkey", "pasta", "cauliflower"], target: 430 },
      { name: "Fish couscous with green beans", components: ["fish", "couscous", "green beans"], target: 410 },
      { name: "Chicken barley with cucumber", components: ["chicken breast", "barley", "cucumber"], target: 420 },
      { name: "Turkey rice with onion and lettuce", components: ["turkey", "white rice", "onion", "lettuce"], target: 430 },
      { name: "Fish pasta with cucumber salad", components: ["fish", "pasta", "cucumber"], target: 410 },
      { name: "Chicken couscous with cabbage", components: ["chicken breast", "couscous", "cabbage"], target: 420 },
      { name: "Tilapia rice with radish", components: ["tilapia", "white rice", "radish"], target: 400 },
      { name: "Egg white pasta with vegetables", components: ["egg white", "pasta", "cabbage", "cucumber"], target: 400 },
      { name: "Turkey couscous with green beans and cauliflower", components: ["turkey", "couscous", "green beans", "cauliflower"], target: 440 },
    ],
  };
